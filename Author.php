    ...
    <div id="top">
        <div id="searchbox" class="container-fluid" style="width:112%;margin-left:-6%;margin-right:-6%;">
            <div>
                <form role="search" action="Result.php" method="post">
                    <input type="text" class="form-control" name="keyword" placeholder="Tìm kiếm theo tên Sách, tên Tác giả hoặc Thể loại." style="width:80%;margin:20px 10% 20px 10%;">
                </form>
            </div>
        </div>
        ...
        <div class="row">
          <div class="col-xs-12 text-center" id="heading">
                 <h2 style="color:#0d6e1d;text-transform:uppercase;margin-bottom:0px;">TÁC GIẢ ' . $author . ' </h2>
           </div>
        </div>      
        <div class="container fluid">
             <div class="row">
